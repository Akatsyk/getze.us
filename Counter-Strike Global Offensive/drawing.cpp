...
void Drawing::CreateFonts()
{
	...
	Source::m_pSurface->SetFontGlyphSet(F::Menu = Source::m_pSurface->CreateFont_(), _("Verdana"), 12, 550, NULL, NULL, FONTFLAG_DROPSHADOW | FONTFLAG_ANTIALIAS);//"Choktoff", 12, 300, NULL, NULL, FONTFLAG_DROPSHADOW | FONTFLAG_ANTIALIAS);
	Source::m_pSurface->SetFontGlyphSet(F::OldESP = Source::m_pSurface->CreateFont_(), _("Verdana"), 12, 700, NULL, NULL, 128); // aimware esp
	Source::m_pSurface->SetFontGlyphSet(F::LBY = Source::m_pSurface->CreateFont_(), _("Verdana"), 26, 700, NULL, NULL, 144);
	Source::m_pSurface->SetFontGlyphSet(MenuText, _("Verdana"), 12, FW_DONTCARE, 0, 0, FONTFLAG_ANTIALIAS);
	LastFontName = ("Small Fonts");
	Source::m_pSurface->SetFontGlyphSet(F::ESPInfo = Source::m_pSurface->CreateFont_(), _("Small Fonts"), 9, 400, NULL, NULL, FONTFLAG_OUTLINE);
	LastFontName = ("Verdana");
	Source::m_pSurface->SetFontGlyphSet(F::Events = Source::m_pSurface->CreateFont_(), _("Verdana"), 12, 400, NULL, NULL, FONTFLAG_DROPSHADOW | FONTFLAG_ANTIALIAS);
	Source::m_pSurface->SetFontGlyphSet(F::NewESP = Source::m_pSurface->CreateFont_(), _("Verdana"), 12, 400, NULL, NULL, FONTFLAG_DROPSHADOW | FONTFLAG_ANTIALIAS);//= Source::m_pSurface->CreateFont_(), "Verdana", 12, 550, NULL, NULL, FONTFLAG_OUTLINE);//"Tahoma", 11, 500, 0, 0, 512);//"Visitor_Rus", 12, 400, NULL, NULL, FONTFLAG_OUTLINE/*FONTFLAG_DROPSHADOW*/);
	LastFontName = ("undefeated");
	Source::m_pSurface->SetFontGlyphSet(F::Weapons = Source::m_pSurface->CreateFont_(), _("undefeated"), 12, 500, NULL, NULL, FONTFLAG_ANTIALIAS); // kms using undefeated fonts
	LastFontName = ("Againts");
	Source::m_pSurface->SetFontGlyphSet(F::Against = Source::m_pSurface->CreateFont_(), _("Againts"), 32, 550, NULL, NULL, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW); // kms using bameware font
	LastFontName = ("eagle");
	Source::m_pSurface->SetFontGlyphSet(F::Eagle = Source::m_pSurface->CreateFont_(), _("eagle"), 36, 550, NULL, NULL, FONTFLAG_ANTIALIAS);
	Source::m_pSurface->SetFontGlyphSet(F::EagleLogo = Source::m_pSurface->CreateFont_(), _("eagle"), 52, 550, NULL, NULL, FONTFLAG_ANTIALIAS);
	Source::m_pSurface->SetFontGlyphSet(F::EagleMisc = Source::m_pSurface->CreateFont_(), _("eagle"), 9, 100, NULL, NULL, FONTFLAG_ANTIALIAS);

	Source::m_pSurface->SetFontGlyphSet(Eagle, _("eagle"), 14, FW_MEDIUM, 0, 0, FONTFLAG_ANTIALIAS);
	Source::m_pSurface->SetFontGlyphSet(mideagle, _("eagle"), 30, FW_MEDIUM, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_ADDITIVE);
	Source::m_pSurface->SetFontGlyphSet(Tabfont, _("eagle"), 42, FW_MEDIUM, 0, 0, FONTFLAG_ANTIALIAS);
	Source::m_pSurface->SetFontGlyphSet(Checkmark, _("eagle"), 10, FW_MEDIUM, 0, 0, FONTFLAG_ANTIALIAS);
	Source::m_pSurface->SetFontGlyphSet(BackArrow, _("eagle"), 18, FW_MEDIUM, 0, 0, FONTFLAG_ANTIALIAS);

	LastFontName = ("Tahoma");
	Source::m_pSurface->SetFontGlyphSet(F::EagleTab = Source::m_pSurface->CreateFont_(), _("Tahoma"), 16, 600, NULL, NULL, FONTFLAG_DROPSHADOW | FONTFLAG_ANTIALIAS);
	Source::m_pSurface->SetFontGlyphSet(ESPFont, _("Tahoma"), 12, FW_MEDIUM, 0, 0, FONTFLAG_DROPSHADOW);
	//"Lucida Console", 10, 0, 0, 0, FONTFLAG_DROPSHADOW
	LastFontName = ("Choktoff");
	Source::m_pSurface->SetFontGlyphSet(hFont, _("Choktoff"), 12, FW_MEDIUM, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	//Interfaces.Surface->SetFontGlyphSet(ESPFont, "Nasalization Rg", 10, FW_NORMAL, 0, 0, FONTFLAG_ANTIALIAS | FONTFLAG_DROPSHADOW);
	LastFontName = ("Segoe UI");
	Source::m_pSurface->SetFontGlyphSet(SegoeUI, _("Segoe UI"), 16, FW_LIGHT, 0, 0, FONTFLAG_ANTIALIAS);
