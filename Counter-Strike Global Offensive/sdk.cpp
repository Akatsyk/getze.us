...
CUserCmd* IInput::GetUserCmd( int sequence_number )
{
	...
	return Memory::VCall<GetUserCmd_t>(this, 8)(this, 0, sequence_number);
}
...
void InitKeyValues(KeyValues* keyValues, const char* name)
{
	...
	if (!dwFunction) dwFunction = Memory::Scan(cheat::main::clientdll, "55 8B EC 51 33 C0 C7 45");
...
void LoadFromBuffer(KeyValues* keyValues, const char* resourceName, const char* pBuffer, void* pFileSystem = nullptr, const char* pPathID = 0, void* pfnEvaluateSymbolProc = nullptr)
{
	...
	if (!dwFunction) dwFunction = Memory::Scan(cheat::main::clientdll, "55 8B EC 83 E4 F8 83 EC 34 53 8B 5D 0C 89 4C 24 04");
